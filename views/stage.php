    ...
    <body >
        ...
        <!-- Centrer le contenu de la page -->
            ...
            <div class="panel panel" style="margin-top: 90px; border:none;"> 
                ...
                <div class="panel-heading" style="background-color:#32475c; color: white; font-size:17px; font-family:Segoe UI"> Recherche des Stagiaires</div>
                                                        ...
                                                        <td style="font-size: 18px;"> 
                                                            <?php 
                                                                if($stagiaire['status'] == 0){
                                                                    echo ' <i class="fa fa-square "  title="En attente" style="color:orange;"> <span style="font-family:Segoe UI">En attente...</span></i> ';
                                                                }elseif($stagiaire['status']==1){
                                                                    echo ' <i class="fa fa-close "  title="Non approuvé" style="color:red"> <span style="font-family:Segoe UI">Non approuvé</span></i> ';
